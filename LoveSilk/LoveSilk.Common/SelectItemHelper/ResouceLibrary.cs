...
namespace LoveSilk.Common.SelectItemHelper
{
    public class ResouceLibrary 
    {
        ...
        {
            return dicConfig.ResourceManager.GetString(ResourceCode);
        }
        ...
        public static void ForEachParm()
        {
            foreach (string Type in Enum.GetNames(typeof(weixinParm)))
            {
                ...
                string ResourceValue = dicConfig.ResourceManager.GetString(EnumCode.GetFieldCode(type));//获取资源文件中存储的值
